module.exports = function() {
  ...
  function getStylesText(node) {
    ...
    const { fontFamily, fontSize, fontWeight, color, textAlign, textTransform, textDecoration, lineHeight } = styles;

    return { fontFamily, fontSize, fontWeight, color, textAlign, textTransform, textDecoration, lineHeight }
  }
  
  function globalizeTextNodes() {
    const nodeList = [];
